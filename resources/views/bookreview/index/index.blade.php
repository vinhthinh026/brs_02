@extends('templates.bookreview.master')
@section('content')
        ...
        <div class="container">
            <div class="bestsellers">
                <div class="home-page-section-four-head">
                    <h2 class="second-color">Bestsellers and Award Winners</h2>
    ...
    <!--START HOME-PAGE-SECTION-FIVE SECTION -->
    <div class="home-page-section-five wrapper">
        <div class="container">
            <div class="discover">
                <div class="home-page-section-five-head">
                    <h2 class="main-color">Discover</h2>
                    <span class="first-line"></span>
                </div>
                <div class="parts">
                    <div class="row">
                ...
                <div class="book-cart-btn">
                    <a class="btn btn-lg discover-view-all-btn" href="books.html">view all <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    <!--END HOME-PAGE-SECTION-FIVE SECTION -->
