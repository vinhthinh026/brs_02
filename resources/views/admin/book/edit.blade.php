        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    {!! Form::open(['method'=> 'put', 'route'=> ['book.update',$objItemBooks->book_id], 'files' => 'true']) !!}
                    <fieldset>
                        <div class="control-group">
                            {!! Form::label( 'name', trans('book.book_name'), ['class'=>'control-label']) !!}
                            <div class="controls">
                                {!! Form::text( 'bname', $objItemBooks->bname, ['class'=>'span6 typeahead']) !!}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {!! Form::text( 'preview', $objItemBooks->preview_text, ['class'=>'span6 typeahead']) !!}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {!! Form::text( 'author', $objItemBooks->author, ['class'=>'span6 typeahead']) !!}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            {!! Form::label( 'name', trans('book.picture'), ['class'=>'control-label']) !!}
                            <div class="controls">
                               <img width="300" height="300" src="../../../storage/app/media/files/book/{{$objItemBooks->picture}}" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {!! Form::number( 'sort', $objItemBooks->sort, ['class'=>'span6 typeahead']) !!}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                {!! Form::textarea('extract', $objItemBooks->extract, ['class'=>'ckeditor']) !!}
                            </div>
                        </div>
